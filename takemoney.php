<?php
	...
	if($_POST[startmoney]<=0||$_POST[startmoney]>1000000000){
	...
	if($userKeepAfter<0){
		echo "<script language=\"javascript\">alert(\"取出金额大于账户余额\");</script>";
		echo "<script language=\"javascript\">history.go(-1);</script>"; 
		exit;
	}
	...
	echo "<script language=\"javascript\">alert(\"成功取出".$_POST[startmoney]."元\");</script>";
